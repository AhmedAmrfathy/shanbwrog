    ...
    return ListView(
      ...
      children: [
        ...
        Container(
          ...
          height: devicesize.width>768?devicesize.height * .67: devicesize.height * .24,
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        height:devicesize.width>768?devicesize.height*.4: devicesize.height * .13,
                        child: Stack(
                          fit: StackFit.expand,
                          children: [
                            ClipRRect(
                      ...
                      Container(
                        width: devicesize.width * .73,
                        child: Row(
                          children: [
                            Text(
                              homeprovider.serviceprovideroffers[index].title!,
                              style:
                                  TextStyle(color: Colors.black, fontSize: 17),
                            ),
                            Spacer(),
                            Text(
                              homeprovider.serviceprovideroffers[index].priceB!,
                              style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.grey,
                            ...
                            Text(
                              homeprovider.serviceprovideroffers[index].priceA!,
                              style: TextStyle(
                                fontSize: 16,
